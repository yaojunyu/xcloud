...
func NewListCommand() *cobra.Command {
	...
	var command = &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			var wfClient v1alpha1.XflowInterface
...
func printTable(wfList []wfv1.Xflow, listArgs *listFlags) {
...
func countPendingRunningCompleted(wf *wfv1.Xflow) (int, int, int) {
	pending := 0
	running := 0
	completed := 0
...
func worklowStatus(wf *wfv1.Xflow) wfv1.NodePhase {
