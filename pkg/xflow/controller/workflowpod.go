...
func addSchedulingConstraints(pod *apiv1.Pod, wfSpec *wfv1.XflowSpec, tmpl *wfv1.Template) {
...
func addVolumeReferences(pod *apiv1.Pod, wfSpec *wfv1.XflowSpec, tmpl *wfv1.Template, pvcs []apiv1.Volume) error {
	switch tmpl.GetType() {
...
func addExecutorStagingVolume(pod *apiv1.Pod) {
	volName := "xflow-controller-staging"
