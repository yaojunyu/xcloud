...
import (
	...
	"github.com/xcloudnative/xcloud/util/retry"
	"github.com/xcloudnative/xcloud/pkg/xflow/common"
	"github.com/xcloudnative/xcloud/pkg/xflow/util"
...
func newWorkflowOperationCtx(wf *wfv1.Xflow, wfc *WorkflowController) *wfOperationCtx {
	// NEVER modify objects from the store. It's a read-only, local cache.
	// You can use DeepCopy() to make a deep copy of original object and modify this copy
	// Or create a copy manually for better performance
	woc := wfOperationCtx{
		wf:      wf.DeepCopyObject().(*wfv1.Xflow),
		orig:    wf,
		updated: false,
...
func (woc *wfOperationCtx) persistWorkflowSizeLimitErr(wfClient v1alpha1.XflowInterface, err error) {
...
func (woc *wfOperationCtx) reapplyUpdate(wfClient v1alpha1.XflowInterface) error {
