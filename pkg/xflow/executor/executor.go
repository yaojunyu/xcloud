...
import (
	...
	artifact "github.com/xcloudnative/xcloud/pkg/xflow/artifacts"
	"github.com/xcloudnative/xcloud/pkg/xflow/artifacts/artifactory"
	"github.com/xcloudnative/xcloud/pkg/xflow/artifacts/git"
	"github.com/xcloudnative/xcloud/pkg/xflow/artifacts/http"
	"github.com/xcloudnative/xcloud/pkg/xflow/artifacts/raw"
	"github.com/xcloudnative/xcloud/pkg/xflow/artifacts/s3"
...
func (we *WorkflowExecutor) SaveArtifacts() error {
	...
	tempOutArtDir := "/xflow-controller/outputs/artifacts"
...
func (we *WorkflowExecutor) SaveLogs() (*wfv1.Artifact, error) {
	...
	tempLogsDir := "/xflow-controller/outputs/logs"
