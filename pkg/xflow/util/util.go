...
import (
	...
	"github.com/xcloudnative/xcloud/pkg/client/clientset/versioned/typed/xcloudnative.io/v1alpha1"
	"github.com/xcloudnative/xcloud/pkg/errors"
	cmdutil "github.com/xcloudnative/xcloud/pkg/util/cmd"
	"github.com/xcloudnative/xcloud/pkg/util/retry"
	unstructutil "github.com/xcloudnative/xcloud/pkg/util/unstructured"
	"github.com/xcloudnative/xcloud/pkg/xflow/common"
	"github.com/xcloudnative/xcloud/pkg/xflow/validate"
)
...
func (l *workflowLister) List() ([]*wfv1.Xflow, error) {
	workflows := make([]*wfv1.Xflow, 0)
...
func FromUnstructured(un *unstructured.Unstructured) (*wfv1.Xflow, error) {
	var wf wfv1.Xflow
...
func ToUnstructured(wf *wfv1.Xflow) (*unstructured.Unstructured, error) {
...
func IsWorkflowCompleted(wf *wfv1.Xflow) bool {
...
func SubmitWorkflow(wfIf v1alpha1.XflowInterface, wf *wfv1.Xflow, opts *SubmitOpts) (*wfv1.Xflow, error) {
	if opts == nil {
		opts = &SubmitOpts{}
	}
	if opts.Entrypoint != "" {
...
func SuspendWorkflow(wfIf v1alpha1.XflowInterface, workflowName string) error {
...
func ResumeWorkflow(wfIf v1alpha1.XflowInterface, workflowName string) error {
	err := wait.ExponentialBackoff(retry.DefaultRetry, func() (bool, error) {
		wf, err := wfIf.Get(workflowName, metav1.GetOptions{})
		if err != nil {
			return false, err
...
func FormulateResubmitWorkflow(wf *wfv1.Xflow, memoized bool) (*wfv1.Xflow, error) {
	newWF := wfv1.Xflow{}
	...
	for key, val := range wf.ObjectMeta.Labels {
		if strings.HasPrefix(key, xcloudnativeio.FullName+"/") && key != common.LabelKeyControllerInstanceID {
			continue
		}
...
func convertNodeID(newWf *wfv1.Xflow, regex *regexp.Regexp, oldNodeID string, oldNodes map[string]wfv1.NodeStatus) string {
...
func RetryWorkflow(kubeClient kubernetes.Interface, wfClient v1alpha1.XflowInterface, wf *wfv1.Xflow) (*wfv1.Xflow, error) {
	switch wf.Status.Phase {
	case wfv1.NodeFailed, wfv1.NodeError:
	default:
...
func IsWorkflowSuspended(wf *wfv1.Xflow) bool {
	if wf.Spec.Suspend != nil && *wf.Spec.Suspend {
		return true
	}
	for _, node := range wf.Status.Nodes {
...
func IsWorkflowTerminated(wf *wfv1.Xflow) bool {
...
func TerminateWorkflow(wfClient v1alpha1.XflowInterface, name string) error {
